...
- [x] 1. Configuration and database schema
  - [x] 1.1 Add `known_fliers_path` and `flier_match_model` fields to `AppConfig` and `load_config()`
  ...
  - [x]* 1.2 Write property test for config field round-trip (Property 1)
  ...
  - [x] 1.3 Add `flier_verified` column to `FlightRecord` model
...
- [x] 2. Implement FlierMatchService core
  - [x] 2.1 Create `flight_card_scanner/services/flier_match_service.py` with class skeleton and TSV loading
  ...
  - [x]* 2.2 Write property test for TSV parsing (Property 2)
  ...
  - [x] 2.3 Implement `build_prompt()` and `build_payload()` methods
  ...
  - [x]* 2.4 Write property test for prompt contents (Property 3)
  ...
  - [x]* 2.5 Write property test for payload structure (Property 7)
  ...
  - [x] 2.6 Implement `parse_response()` and `get_row_by_line_number()` methods
  ...
  - [x]* 2.7 Write property test for response parsing (Property 4)
  ...
  - [x] 2.8 Implement `match_flier()` async method
...
- [x] 4. Integration into extraction pipeline
  - [x] 4.1 Initialize `FlierMatchService` in application lifespan (`main.py`)
  ...
  - [x] 4.2 Add `flier_match_service` parameter to `ExtractionService` and call in `_process()`
  ...
  - [x]* 4.3 Write property test for successful match application (Property 5)
  ...
  - [x]* 4.4 Write property test for no-match preservation (Property 6)
  ...
  - [x]* 4.5 Write unit tests for FlierMatchService integration
